...
const CACHE = "baobaoxiang-v7a2c2eef";
const FILES = ["./","./index.html","./manifest.json","./apple-touch-icon.png","./icon-192.png","./icon-512.png","./assets/index-BAc0_St0.js","./assets/index-uQRaXjKF.css"];
