...
const CACHE = "baobaoxiang-vc4c7915b";
const FILES = ["./","./index.html","./manifest.json","./apple-touch-icon.png","./icon-192.png","./icon-512.png","./assets/index-JVdZemCN.css","./assets/index-yxs94a5C.js"];
