...
const CACHE = "baobaoxiang-v389ea85c";
const FILES = ["./","./index.html","./manifest.json","./apple-touch-icon.png","./icon-192.png","./icon-512.png","./assets/index-C32-Ps7Y.css","./assets/index-DQsTPasd.js"];
