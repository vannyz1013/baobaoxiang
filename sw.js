...
const CACHE = "baobaoxiang-v8cf3c638";
const FILES = ["./","./index.html","./manifest.json","./apple-touch-icon.png","./icon-192.png","./icon-512.png","./assets/index-D3fmBZWG.css","./assets/index-G83LzoQp.js"];
